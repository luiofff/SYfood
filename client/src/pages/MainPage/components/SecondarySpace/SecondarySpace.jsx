        ...
        <div className={styles.card_space}>
            <div className={styles.card}>
                ...
                <div className={styles.card_content_block}>
                    ...
                    <p className={styles.card_pre_title}>Хорошо, для тебя я предлагаю приготовить "Аджарские хачапури". Они являются классическим грузинским блюдом, которое сочетает в себе сырную начинку и хрустящую выпечку...</p>
