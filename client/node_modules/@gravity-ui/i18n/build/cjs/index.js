...
class I18N {
    ...
    i18n(keysetName, key, params) {
        ...
        if (Array.isArray(keyValue)) {
            ...
            result = keyValue[pluralizer(count, types_1.PluralForm)] || keyValue[types_1.PluralForm.Many];
            if (keyValue[types_1.PluralForm.None] === undefined) {
        ...
        if (params) {
            result = (0, replace_params_1.replaceParams)(result, params);
        }
        return result;
    }
    keyset(keysetName) {
    ...
    getLanguagePluralizer(lang) {
        ...
        return pluralizer || en_1.default;
    }
}
exports.I18N = I18N;
